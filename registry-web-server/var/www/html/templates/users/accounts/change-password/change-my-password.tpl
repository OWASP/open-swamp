<form action="/" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="password" autocomplete="off" class="required" id="current-password" maxlength="200" data-toggle="popover" data-placement="right" title="Current password" data-content="Your current password that you would like to change." />
		</div>
	</div>
...
<div class="buttons">
	...
	<button id="reset" class="btn btn-large"><i class="fa fa-repeat"></i>Reset Password</button>
</div>
