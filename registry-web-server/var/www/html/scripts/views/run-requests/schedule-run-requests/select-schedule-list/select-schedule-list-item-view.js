/******************************************************************************\
|                                                                              |
|                           select-schedule-list-item-view.js                  |
|                                                                              |
|******************************************************************************|
|                                                                              |
...
define([
	...
	'backbone',
	'marionette',
	'text!templates/run-requests/schedule-run-requests/select-schedule-list/select-schedule-list-item.tpl',
	'scripts/registry',
	...
	return Backbone.Marionette.ItemView.extend({
		...
		template: function(data) {
			return _.template(Template, _.extend(data, {
				...
				url: data.project_uuid !== ''? '#run-requests/schedules/' + this.model.get('run_request_uuid') + 
