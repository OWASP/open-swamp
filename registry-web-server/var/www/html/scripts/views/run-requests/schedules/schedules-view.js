...
define([
	...
	'backbone',
	'marionette',
	'text!templates/run-requests/schedules/schedules.tpl',
	'scripts/registry',
	...
	return Backbone.Marionette.LayoutView.extend({
		...
		fetchSchedules: function(done) {
			...
			if (this.options.data['project']) {
				...
				//
				collection.fetchByProject(this.options.data['project'], {
				...
				//
				collection.fetchByProjects(this.options.data['projects'], {
					data: this.scheduleFilters.currentView.getData(),
