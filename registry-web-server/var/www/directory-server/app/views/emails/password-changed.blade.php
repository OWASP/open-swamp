...
<body>
	<div>
		...
		You may contact swamp security directly at security@continuousassurance.org, or visit the security contact page for more options:  <a href="{{ $url }}/#contacts/security">Contact SWAMP Security</a>
